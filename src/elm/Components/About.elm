...
body = 
  div [ class "about-body"] 
      ...
      , p [] [ span [ class "highlight-word" ] [ text ("Building") ], text (" useful and beautiful "), span [ class "highlight-word" ] [ text ("software") ], text (" products is what gets me out of bed in the morning — aside from morning workouts, almond butter and my space heater, of course.") ]
